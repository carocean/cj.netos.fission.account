...
public interface BusinessBillMapper {
    ...
    List<BusinessBill> pageByOrder(@Param(value = "order") int order, @Param(value = "limit") int limit,@Param(value = "offset")  long offset);
    List<BusinessBill> page(@Param(value = "limit") int limit,@Param(value = "offset")  long offset);
}