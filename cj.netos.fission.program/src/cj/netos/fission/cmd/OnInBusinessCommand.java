...
@CjConsumer(name = "fission-mf-account-on-recharge")
@CjService(name = "/fission/account.mhub#inBusiness")
public class OnInBusinessCommand implements IConsumerCommand {
    @CjServiceRef
